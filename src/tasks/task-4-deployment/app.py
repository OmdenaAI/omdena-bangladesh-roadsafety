...
option = st.sidebar.selectbox('Select from below', ( "Summary of Statistics", "Geographic Heatmaps", "Vehicle Tracking Results", 'Time-Series Solutions', "Explore Our Awesome Datasets"))
...
if option == "Vehicle Tracking Results":

    st.markdown("here goes CV results")


# --------------------------------------------------------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------------------- Vehicle Traciking Results ends here
# --------------------------------------------------------------------------------------------------------------------------------------------------
